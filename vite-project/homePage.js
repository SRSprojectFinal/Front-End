...
if (localStorage.getItem("token") == null) {
  ...
  if(loggedEmail.includes("@student.srs.edu") || loggedUser.type === "ALUNO") {
    navLinks.insertAdjacentHTML("beforeend", `<li class="studentSection"><a href="http://localhost:3000/StudentSection/studentSection.html">Student Section</a></li>`);
    cart.style.display = "flex";
  }

  if(loggedEmail.includes("@professor.srs.edu") || loggedUser.type === "PROFESSOR") {
    navLinks.insertAdjacentHTML("beforeend", `<li class="professorSection"><a href="http://localhost:3000/ProfessorSection/professorSection.html">Professor Section</a></li>`);
    canAddToCart = false;
  }
...
function goToViewReviews(){
  window.location.href = "http://localhost:3000/#viewReviewsSection"
}
